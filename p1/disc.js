...
class Disc  {
    ...
    * @param {float} theta  degrees drawn out
	* @return {none} It's a constructor
	*/
    constructor(slices, stacks, outer_radius, inner_radius, outer_center, inner_center, theta) {
        this.InitializeVertices(slices, stacks, outer_radius, inner_radius, outer_center, inner_center, theta);
	...
	* @param {float} or	outer radius
    * @param {float} ir	inner radius
    * @param {float[]} oc outer center
    * @param {float[]} ic inner center
	* @return {none}
	*/
    InitializeVertices(slices, stacks, or, ir, oc, ic, theta) {
		if (slices < 2)
		...
		*/
        ...
        this.RecalculateNormals(1.0);
		// this.RecalculateDisplayNormals(); // this is done in recalculate normals()
	}
